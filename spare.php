...
<body>
	...
	<div class="main-area" style="background-color: black;">
		<div class="container full-height position-static">

			<section class="left-section full-height" >
					<a class="logo" href="#">kartlevi.com | LOGO</a>
					
				<div class="display-table">
					<div class="display-table-cell">
						<div class="main-content">
							<h1 class="title"><b>kartlevi.com</b></h1>
							<p>Website Under Development.
								We should be launching soon. Thank you and subscribe to our newsletter in order not to miss anything.</p>

							<div class="email-input-area">
								<form method="post">
									<input class="email-input" name="email" type="text" placeholder="johndoe@example.com"/>
									<button class="submit-btn" name="submit" type="submit"><b>NOTIFY US</b></button>
								</form>
							</div><!-- email-input-area -->

							<p class="post-desc">subscribe to newsletter to stay up to date </p>
						</div><!-- main-content -->
